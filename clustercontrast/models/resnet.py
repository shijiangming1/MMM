...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        model_path='/home/hwpeng/ProjectHWPeng/SharedCodeModel/Papers_Publish_Code/ADCA/ADCA-master/examples/pretrained/resnet50-19c8e357.pth'
        print('pretrained model loading:',model_path)
