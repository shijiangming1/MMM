...
def dual_compute_jaccard_distance(target_features, target_features_middle, k1=20, k2=6, weight=0.5, print_flag=True, search_option=0, use_float16=False):
    jaccard_distance=compute_jaccard_distance(target_features, k1=k1, k2=k2,
                                                       search_option=3)  # rerank_dist_all_jacard[:features_rgb.size(0),:features_rgb.size(0)]#
    jaccard_distance_middle=compute_jaccard_distance(target_features_middle, k1=k1, k2=k2,
                                                       search_option=3)  # rerank_dist_all_jacard[:features_rgb.size(0),:features_rgb.size(0)]#
    jaccard_distance_final=weight*jaccard_distance + (1-weight)*jaccard_distance_middle

    return jaccard_distance_final